...
///Creates a very simple api to impalement a listenable controller denouncer.
///which can be used easily without using any StreamControllers to help catch the
///data stream and process it.
///
class TimeDenouncer<T> {
